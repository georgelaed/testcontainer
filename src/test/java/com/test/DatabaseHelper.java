...
public class DatabaseHelper implements AutoCloseable {
    ...
    public static DatabaseHelper getInstance(JdbcDatabaseContainer<?> dbContainer) {
        if (databaseHelper == null) {
            synchronized (DatabaseHelper.class) {
                if (databaseHelper == null) {
                    databaseHelper = new DatabaseHelper(dbContainer);
                }
            }
        }

        log.info("Got DB Helper instance {}!", databaseHelper);
        return databaseHelper;
    }

    private DatabaseHelper(JdbcDatabaseContainer<?> dbContainer) {
